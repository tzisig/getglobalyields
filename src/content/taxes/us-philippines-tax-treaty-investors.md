---
slug: us-philippines-tax-treaty-investors
title: "US-Philippines Tax Treaty: Resident and OFW Rules for Investors (2026)"
...
<!-- ADSENSE / AFFILIATE PLACEHOLDER
     Position: Mid-article, after resident/OFW section
...
Claiming the 25% rate (instead of the 30% default) requires Form [W-8BEN](/taxes/w8ben-form-non-us-investors/) filed with your broker - the same mechanism used across every country in this series. Check your dividend statement: 25% confirms the treaty rate is active; 30% means the form is missing or has lapsed.
