...
description: "US-Czech Republic tax treaty guide for individual investors. Withholding rates on dividends, the 3-year capital gains exemption, W-8BEN filing, and how Czech tax law interacts with US rules explained."
pubDate: 2026-06-16
...
tags:
  ...
  - "Czech investor US stocks"
  - "W-8BEN Czech Republic"
  - "Czech capital gains exemption 3 years"
  - "double taxation Czech Republic US"
...
featured: true
seo:
  metaTitle: "US-Czech Republic Tax Treaty Guide for Czech Investors (2026)"
  metaDescription: "How the US-Czech Republic tax treaty affects Czech residents investing in US markets. Learn about the 15% dividend withholding tax and W-8BEN form."
  ogTitle: "US-Czech Republic Tax Treaty Guide for Czech Investors (2026)"
  ogDescription: "How the US-Czech Republic tax treaty affects Czech residents investing in US markets. Learn about the 15% dividend withholding tax and W-8BEN form."
...
schema:
  ...
  description: "How the US-Czech Republic tax treaty affects Czech residents investing in US markets. Learn about the 15% dividend withholding tax and W-8BEN form."
  author: "Tzion S."
...
<!-- ADSENSE / AFFILIATE PLACEHOLDER
     Position: Mid-article, after core opportunity section
...
**Worked example - Martin at the 15% Czech rate:** (our [investment calculators](/resources/calculators/) tool can run this against your own dividend income)
...
The clock starts from the date of acquisition and must be uninterrupted. If you sell before three years have passed - by even a day - the exemption does not apply and the full gain is taxable. For a real example of how multi-year holding periods and volatility play out, see our [TQQQ recovery case study](/case-study/from-minus-70-to-plus-492k-real-tqqq-recovery-case-study/).
...
- Line 11: Your Czech tax identification number (rodnײ³ֲ© ײ´ֲײ³ֲ­slo or DIײ´ֲ - see our [glossary](/resources/glossary/) if these terms are unfamiliar)
...
Czech tax residents are required to report worldwide income, including all foreign investment income. US dividends and capital gains from US stocks require entries in the Czech personal income tax return (Pײµג„¢iznײ³ֲ¡nײ³ֲ­ k dani z pײµג„¢ײ³ֲ­jmײµֲ¯ fyzickײ³ֲ½ch osob).

**For US dividends:**
- Report the gross amount (before US withholding) under the foreign income category
- Complete the annex for foreign income (pײµג„¢ײ³ֲ­loha ײ´ֲ. 3)
- Claim the foreign tax offset (zײ³ֲ¡poײ´ֲet danײ´ג€÷ zaplacenײ³ֲ© v zahraniײ´ֲײ³ֲ­) for the 15% US withholding
...
This section applies to US citizens and Green Card holders living in the Czech Republic. The compliance picture is different from that of non-US Czech residents. For the broader cross-border picture, see our [expat financial planning guide](/us-investing/expat-financial-planning-managing-investments-across-borders/).
...
| [Bulgaria](/taxes/us-bulgaria-tax-treaty-investors/) | **10%** | 5% | Residence only | No |
| [Denmark](/taxes/us-denmark-tax-treaty-investors/) | 15% | **0%** | Residence only | 0% (pension fund) |
| [United Kingdom](/taxes/us-uk-tax-treaty-investors/) | 15% | **0%** | Residence only | No annual exemption cap for ISA |
| [Australia](/taxes/us-australia-tax-treaty-investors/) | 15% | 10% | Residence only | No |
| [Germany](/taxes/us-germany-tax-treaty-investors/) | 15% | **0%** | Residence only | No (Abgeltungsteuer applies) |
...
**Not filing W-8BEN at account opening.** Interactive Brokers collects this during the Czech Republic application process, but if the form was skipped or not completed correctly, 30% is being withheld instead of 15%. Verify against your dividend statements. Our [best brokers for international investors](/best-brokers/best-brokers-international-investors-2026/) roundup covers other platforms that handle this the same way.
...
- [ ] Report gross US dividends on Czech tax return (pײµג„¢ײ³ֲ­loha ײ´ֲ. 3) and claim the 15% US withholding as a foreign tax credit
