...
featured: false
seo:
  metaTitle: "US-Malaysia Tax Treaty: FSI Exemption Explained (2026)"
  metaDescription: "How the US-Malaysia tax treaty caps dividend withholding at 15%. Malaysia's Foreign-Sourced Income exemption (extended to 2036) and what it means for US stock investors."
  ogTitle: "US-Malaysia Tax Treaty: FSI Exemption Explained (2026)"
  ogDescription: "How the US-Malaysia tax treaty caps dividend withholding at 15%. Malaysia's Foreign-Sourced Income exemption (extended to 2036) and what it means for US stock investors."
  ogImage: "/images/blog/taxes/us-malaysia-tax-treaty.webp"
  twitterCard: "summary_large_image"
schema:
  type: "article"
  headline: "US-Malaysia Tax Treaty: FSI Exemption Explained (2026)"
  description: "How the US-Malaysia tax treaty caps dividend withholding at 15%. Malaysia's Foreign-Sourced Income exemption (extended to 2036) and what it means for US stock investors."
  author: "Tzion S."
  datePublished: "2026-08-11"
  dateModified: "2026-08-11"
  image: "/images/blog/taxes/us-malaysia-tax-treaty-investors.webp"
  mainEntityOfPage: "https://getglobalyields.com/taxes/us-malaysia-tax-treaty-investors"
---
...
Malaysia's Foreign-Sourced Income (FSI) exemption, extended under Budget 2026 through **December 31, 2036**, covers foreign dividends and capital gains from foreign asset sales - including US stocks - brought into Malaysia by a tax resident, provided the income was already taxed in the country where it arose. Given that US dividends are withheld at 15% under the treaty, and the exemption's condition requires the origin country's headline tax rate to be at least 15%, US dividend income remitted to Malaysia has a real path to facing **no additional Malaysian tax at all**.

That exemption, not the treaty rate itself, is what should shape a Malaysian investor's planning. This guide covers both: the treaty's standard 15% dividend withholding, and the FSI exemption's mechanics and conditions in enough detail to actually apply it correctly.
...
- For dividend income specifically, the **headline tax rate in the origin country must be at least 15%** - the US federal corporate/withholding framework clears this bar for treaty-rate dividend withholding.
...
*Sources: US-Malaysia tax arrangements and IRS treaty tables; PwC Malaysia Tax Summaries (2026).*

Claiming the 15% rate requires Form [W-8BEN](/taxes/w8ben-form-non-us-investors/) filed with your broker. Without it, the full 30% default applies from the first dividend payment - and importantly for the FSI exemption analysis above, the 30% non-treaty rate would still likely clear the "similar character to income tax" and headline-rate conditions, but there's no reason to accept the higher rate when W-8BEN is a simple form to file correctly from the start.

---

## Broker Access

Both Interactive Brokers and eToro are confirmed to accept Malaysian residents for account opening. Confirm current requirements directly before applying, since broker policies for specific countries can change.

---

## Practical Checklist

**Malaysian resident investing in US stocks:**
...
The treaty rate is standard and easily solved: 15% on dividends with W-8BEN filed. What makes Malaysia genuinely favorable for a US-stock-focused investor is the FSI exemption - extended a full decade to 2036 under Budget 2026, and explicitly covering both foreign dividends and foreign capital gains when remitted and properly documented. For most Malaysian investors, correctly satisfying the exemption's documentation requirements is worth more than any other single decision in this guide.

---

*This article is informational only and does not constitute tax or legal advice. Treaty rates are based on the US-Malaysia tax arrangement per IRS treaty tables. Malaysia's Foreign-Sourced Income exemption conditions and duration are set by Malaysian budget legislation and can change - always consult a qualified Malaysian tax advisor (or LHDN directly) for advice specific to your situation and to confirm current exemption conditions before relying on them.*
