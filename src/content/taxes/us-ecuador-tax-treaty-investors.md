...
## Ecuador's Domestic Side: Dividends Withheld at 12% - For Ecuadorian Sources

Ecuador withholds tax on dividends paid by Ecuadorian companies to resident individuals at up to **12%**. Capital gains are generally treated as ordinary income, with securities not traded on an Ecuadorian exchange facing a 10% rate on the gain.

**For US-sourced dividends and capital gains specifically:** general guidance indicates that US investment income is treated as US-source, not Ecuador-source, and that foreign income already subject to tax in another jurisdiction generally isn't taxed again in Ecuador. In practice, this means the 30% already withheld by the US is likely to be the dominant, if not the entire, tax cost for a typical individual investor - though **confirm the precise domestic mechanics with an Ecuadorian tax advisor** before assuming a specific outcome, since this guide found general statements to that effect rather than a fully detailed statutory citation.
...
**The practical result for an Ecuadorian resident:** funding an Interactive Brokers or eToro account involves a straightforward USD wire transfer, not a currency exchange - no spread to pay a bank or broker for converting currencies, no exchange-rate timing to think about, and no exposure to a devaluation event of the kind some neighboring economies in this series have experienced. This is a genuinely structural advantage unique to Ecuador (and Panama and El Salvador, among a small number of other dollarized economies) that most investors researching this topic don't immediately associate with a country better known for the reverse - being a heavily cash-based, historically volatile economy before 2000.
