...
<!-- ADSENSE / AFFILIATE PLACEHOLDER
     Position: Mid-article, after current status section
...
| Income Type | Current (Treaty Not in Force) | Once in Force (Portfolio) | Once in Force (Direct Corporate, 10%+) |
|---|---|---|---|
| Dividends | 30% (US default) | **15%** | **5%** |
