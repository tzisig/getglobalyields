...
featured: false
seo:
  metaTitle: "US-France Tax Treaty Guide: Why the PEA Can't Hold US Stocks (2026)"
  ...
  ogTitle: "US-France Tax Treaty Guide: Why the PEA Can't Hold US Stocks (2026)"
...
schema:
  type: "article"
  headline: "US-France Tax Treaty Guide: Why the PEA Can't Hold US Stocks (2026)"
  ...
  mainEntityOfPage: "https://getglobalyields.com/taxes/us-france-tax-treaty-investors"
---
...
That access question shapes the rest of this guide more than the treaty rate does. The US-France tax treaty itself caps dividend withholding at a standard **15%**, claimed with [W-8BEN](/taxes/w8ben-form-non-us-investors/). This guide covers that rate, the PEA exclusion in more detail, France's flat 30% tax on investment income (the PFU), and broker access for French residents.
...
<!-- ADSENSE / AFFILIATE PLACEHOLDER
     Position: Mid-article, after PEA section
...
- Total tax paid (US + France): €300 + €300 = €600 - France's 30% flat rate applied once, no double taxation
...
Both Interactive Brokers and eToro are confirmed to accept French residents for account opening. Neither changes the PEA-eligibility question above - that's a French account-structure rule, not a broker policy - but both give direct access to US-listed stocks and ETFs through a standard taxable account.

---

## Practical Checklist

**French resident investing in US stocks:**
...
*This article is informational only and does not constitute tax or legal advice. Treaty rates are based on the US-France Income Tax Convention as amended. French PEA eligibility rules and PFU rates reflect 2026 guidance and can change. Always consult a qualified French tax advisor (comptable) for advice specific to your situation.*
