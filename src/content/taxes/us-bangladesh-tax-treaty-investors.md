...
tags:
  ...
  - "interactive brokers bangladesh"
  - "etoro bangladesh"
  - "bangladesh bank remittance"
heroImage: "/images/blog/taxes/us-bangladesh-tax-treaty-investors.webp"
heroImageWidth: 840
heroImageHeight: 560
draft: true
...
## The USD 12,000 Personal Remittance Quota

Bangladesh Bank permits resident individuals to remit up to approximately **USD 12,000 per calendar year** for personal purposes through an Authorized Dealer (AD) bank, without needing prior Bangladesh Bank approval - the transaction is simply endorsed in your passport. This is the mechanism most individuals use for routine outward transfers.

**What this guide could not confirm with full certainty:** whether this general personal-purpose quota is the same channel used for funding a foreign securities brokerage account, or whether Bangladesh Bank treats portfolio investment abroad as a separate category with its own rules. Non-resident portfolio investment *into* Bangladesh has clear, well-documented rules; the reverse direction - a resident funding a foreign brokerage account - is less clearly documented in public guidance. **Confirm directly with your AD bank whether the standard personal quota covers this purpose** before relying on it for a brokerage transfer, rather than assuming it automatically applies.

**In practice:** USD 12,000/year is enough to open and meaningfully fund a starter position with a broker like Interactive Brokers for most individual investors, even if it isn't unlimited.

---

<!-- ADSENSE / AFFILIATE PLACEHOLDER
     Position: Mid-article, after remittance section
     Recommended: Contextual AdSense unit or broker comparison affiliate
     Replace this comment block with your AdSense tag or affiliate banner HTML -->

---

## Bangladesh's Domestic Tax: Worldwide Income, With a Classification Question

Bangladesh taxes residents on **worldwide income**, with foreign-source income included in taxable income and relief available for foreign tax already paid, either under the treaty or (absent a treaty) at an average domestic rate.

**Bangladesh-source dividends** are taxed at a flat **10%** for resident individuals, with the first **BDT 25,000** of dividend income tax-free. **Capital gains** from transferring capital assets are generally taxed at **15%**.

**The open question for US dividends specifically:** whether the flat 10% domestic dividend rate (built around Bangladeshi company dividends) extends the same way to a foreign dividend, or whether foreign-source dividend income instead gets folded into your regular progressive income tax slabs as part of worldwide income - similar to a pattern seen in several other countries in this series where a headline domestic rate turns out to be source-specific. **Confirm the correct classification with a Bangladeshi tax advisor (NBR-registered)** before assuming either treatment applies to your US dividends.
