...
Switzerland is one of the few countries in this series with a genuine, ongoing **wealth tax** - not a deemed-return calculation like Denmark's ASK or the Netherlands' Box 3, but an actual annual levy on your net worldwide assets, US stocks included. There's no federal version of it; each of Switzerland's 26 cantons sets its own rate and exemption threshold, and the difference between cantons is large enough to matter: a married couple with CHF 1 million in net assets pays roughly CHF 1,253 a year in Nidwalden, and roughly CHF 6,804 in Neuchâtel for the identical net worth - more than a 5x difference based purely on canton of residence.

This guide covers that wealth tax, the treaty's standard 15% dividend rate, and how the two interact for a Swiss-resident investor holding US stocks.

---

## The Cantonal Wealth Tax: Real, Annual, and Canton-Dependent

Switzerland's net wealth tax is assessed at the cantonal and communal level on your total worldwide assets minus total debts, as of December 31 each year - US brokerage account holdings included at their year-end market value.

**Rates vary substantially by canton**, generally in the range of roughly 0.1% to 1% depending on where you live and how much you hold. Zurich's 2026 schedule for single filers, for example, tops out at 0.30% on wealth above CHF 3,304,000 - but the exact bracket structure and top marginal rate differ meaningfully canton by canton, and some cantons are considerably more expensive than others at the same wealth level, as the Nidwalden-versus-Neuchâtel comparison above illustrates.

**What this means for a US stock investor:** the wealth tax applies regardless of whether your US stocks paid a dividend or were sold that year - it's a tax on the asset's value, not its income. A large, low-yield growth position (the kind that produces minimal dividend income) still generates a wealth tax bill based on its year-end market value, which is a meaningfully different planning consideration than the income-tax-only frameworks most other countries in this series use.

**For anyone with real flexibility in choosing where to live within Switzerland**, the cantonal variation is worth factoring into that decision alongside the more commonly discussed cost-of-living and income-tax differences between cantons - a wealth tax difference of several thousand francs a year, compounding over a long holding period, is a real number.

---

<!-- ADSENSE / AFFILIATE PLACEHOLDER
     Position: Mid-article, after wealth tax section
