---
slug: us-ethiopia-tax-treaty-investors
title: "US-Ethiopia Tax Treaty for Investors: After the Birr Float (2026)"
...
schema:
  ...
  mainEntityOfPage: "https://getglobalyields.com/taxes/us-ethiopia-tax-treaty-investors"
---
...
With no comprehensive income tax treaty between the US and Ethiopia, there's no treaty article to reduce the default rate. Every US dividend paid to an Ethiopia-resident investor is withheld at the full **30% statutory rate**.
...
<!-- ADSENSE / AFFILIATE PLACEHOLDER
     Position: Mid-article, after currency section
...
Interactive Brokers is confirmed to accept Ethiopia-resident investors for account opening, alongside eToro.

---

## Practical Checklist

**Ethiopian resident investing in US stocks:**
...
There's no comprehensive US-Ethiopia tax treaty, so the full 30% US withholding applies with no reduction available - W-8BEN still matters for documentation, not for a lower rate. The genuinely significant recent change is the 2024 birr float and its continuing 2026 liberalization, which reshaped how Ethiopians access foreign currency after decades of tight controls. On the tax side, be aware that Ethiopia's capital gains rate on shares has real, unresolved conflicts in available guidance - confirm the current figure directly rather than trusting either number in isolation.

---

*This article is informational only and does not constitute tax or financial advice. There is no comprehensive US-Ethiopia income tax treaty. Ethiopia's foreign exchange regime and capital gains tax rates have both changed substantially and recently - always confirm current rules directly with an Ethiopian bank and a qualified Ethiopian tax advisor before relying on anything in this guide.*
