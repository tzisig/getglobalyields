...
title: "How to Open a US Brokerage Account as a Non-Resident (2026)"
...
## **The W-8BEN Form: What It Is and Why You Need It**

The W-8BEN is an IRS form that certifies you are a foreign person for US tax purposes. By submitting it, you confirm that you are not a US citizen or resident, which determines how your investment income is taxed.
...
### **Step 1: Choose a Broker That Accepts Your Country**

Not all brokers accept international clients. Use the list below to identify which ones are available in your country of residence.
...
Most brokers have a fully online process. Set aside 20–30 minutes. You will be asked about your investment experience, financial situation, and source of funds.
...
TD Ameritrade merged with Charles Schwab in 2020, and international accounts are now handled under the Schwab umbrella. Schwab International accepts clients from select countries and offers a robust platform with excellent research tools.
...
| **Broker** | **Countries** | **Min. Deposit** | **Options** | **Best For** |
| --- | --- | --- | --- | --- |
| Interactive Brokers | 200+ | $0 | Yes | All-around |
| Tastytrade | Select | $0 | Yes (specialty) | Options traders |
| Firstrade | Many | $0 | Yes | Beginners |
| Schwab / TDA | Select | $0 | Yes | Research-focused |
...
Yes, and it works in your favor. A tax treaty reduces the dividend withholding rate below the standard 30%. Check IRS Publication 515 for a full list of treaty countries.
...
No. Using a VPN to appear as if you are in a different country violates broker terms of service and can result in account closure.
